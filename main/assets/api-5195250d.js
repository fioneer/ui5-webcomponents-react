import{j as e}from"./jsx-runtime-d079401a.js";import{H as q,b as x}from"./chunk-PCJTTTQV-e21f59cf.js";import{r as N}from"./index-f1f2c4b1.js";function p(r){return r?r.map((n,i,a)=>{let c=n.name;return a.length>1&&i+1!==a.length&&(c+=", "),c}):""}const l=({api:r})=>r.map(n=>{var c,d,u,b,g,y,h;const{signatures:i}=n,{parameters:a}=i[0];return e.jsxs(N.Fragment,{children:[e.jsx(q,{children:n.name}),e.jsxs("code",{children:[n.name,"(",a==null?void 0:a.map(t=>{var s,o;return`${t.name}:${t.type.name}${(o=(s=t.type)==null?void 0:s.typeArguments)!=null&&o.length?`<${p(t.type.typeArguments)}>`:""}`}).join(", "),"):",(d=(c=i[0])==null?void 0:c.type)==null?void 0:d.name,`<${p((u=i[0].type)==null?void 0:u.typeArguments)}>`]}),e.jsxs("div",{children:[e.jsx(x,{children:(b=i[0])==null?void 0:b.comment.summary.reduce((t,s)=>`${t}${s.text.replaceAll(`
...
`,"<br>")}`,"")})]},t.name)})})]})]}),e.jsxs("p",{children:[e.jsx("b",{children:"Source:"})," ",e.jsx("a",{href:n.sources[0].url,children:`${n.sources[0].fileName}:${n.sources[0].line}`})]})]}),e.jsx("br",{}),e.jsx("br",{})]},n.name)});l.displayName="CommandsAndQueries";try{l.displayName="CommandsAndQueries",l.__docgenInfo={description:"",displayName:"CommandsAndQueries",props:{api:{defaultValue:null,description:"",name:"api",required:!0,type:{name:"CommandsAndQueries[]"}}}}}catch{}const _=0,v="ui5-webcomponents-react",T="project",F=1,U={},I=[{id:28,name:"src",variant:"declaration",kind:2,flags:{},sources:[{fileName:"index.ts",line:1,character:0,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/index.ts#L1"}]},{id:1,name:"src/commands",variant:"declaration",kind:2,flags:{},children:[{id:2,name:"Cypress",variant:"declaration",kind:4,flags:{},children:[{id:3,name:"Chainable",variant:"declaration",kind:256,flags:{},children:[{id:25,name:"clickUi5ListItemByText",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:61,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L61"}],signatures:[{id:26,name:"clickUi5ListItemByText",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Click on a list item of the "},{kind:"code",text:"`List`"},{kind:"text",text:" component by text."}],blockTags:[{tag:"@example",content:[{kind:"code",text:'```ts\ncy.clickUi5ListItemByText("List Item")\n```'}]}]},sources:[{fileName:"commands.ts",line:61,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L61"}],parameters:[{id:27,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"The text of the list item that should be clicked."}]},type:{type:"intrinsic",name:"string"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:21,name:"clickUi5RadioButton",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:48,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L48"}],signatures:[{id:22,name:"clickUi5RadioButton",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Click on a "},{kind:"code",text:"`ui5-radio-button`"}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-radio-button]').clickUi5RadioButton();\n```"}]}]},sources:[{fileName:"commands.ts",line:48,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L48"}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:23,name:"closeUi5PopupWithEsc",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:54,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L54"}],signatures:[{id:24,name:"closeUi5PopupWithEsc",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Close ui5-webcomponents popups like "},{kind:"code",text:"`ui5-dialog`"},{kind:"text",text:" or "},{kind:"code",text:"`ui5-popover`"},{kind:"text",text:' by pressing the "Escape" key.'}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.closeUi5PopupWithEsc()\n```"}]}]},sources:[{fileName:"commands.ts",line:54,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L54"}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:17,name:"toggleUi5Checkbox",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:36,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L36"}],signatures:[{id:18,name:"toggleUi5Checkbox",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Toggles the state of a "},{kind:"code",text:"`ui5-checkbox`"},{kind:"text",text:"."}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-checkbox]').toggleUi5Checkbox();\n```"}]}]},sources:[{fileName:"commands.ts",line:36,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L36"}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:19,name:"toggleUi5Switch",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:42,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L42"}],signatures:[{id:20,name:"toggleUi5Switch",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Toggles the state of a "},{kind:"code",text:"`ui5-switch`"}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-switch]').toggleUi5Switch();\n```"}]}]},sources:[{fileName:"commands.ts",line:42,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L42"}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:4,name:"typeIntoUi5Input",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:11,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L11"}],signatures:[{id:5,name:"typeIntoUi5Input",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Types a value into a ui5-webcomponent that offers a typeable input field."}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-input]').typeIntoUi5Input('Hello World');\n```"}]}]},sources:[{fileName:"commands.ts",line:11,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L11"}],parameters:[{id:6,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"Text that will be typed into the input."}]},type:{type:"intrinsic",name:"string"}},{id:7,name:"options",variant:"param",kind:32768,flags:{isOptional:!0},type:{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.es5.d.ts",qualifiedName:"Partial"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.TypeOptions"},name:"TypeOptions",package:"cypress",qualifiedName:"Cypress.TypeOptions"}],name:"Partial",package:"typescript"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:8,name:"typeIntoUi5InputWithDelay",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:23,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L23"}],signatures:[{id:9,name:"typeIntoUi5InputWithDelay",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:`Types a value with a delay into an ui5-webcomponent that offers a typeable input field.
...
The delay time can vary from environment to environment.`}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-combobox]').typeIntoUi5InputWithDelay('Hello World', 1000);\n```"}]}]},sources:[{fileName:"commands.ts",line:23,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L23"}],parameters:[{id:10,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"Text that will be typed into the input."}]},type:{type:"intrinsic",name:"string"}},{id:11,name:"delay",variant:"param",kind:32768,flags:{isOptional:!0},comment:{summary:[{kind:"text",text:"Delay in ms to wait for the web-component to be ready. Default: 500"}]},type:{type:"intrinsic",name:"number"}},{id:12,name:"options",variant:"param",kind:32768,flags:{isOptional:!0},type:{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.es5.d.ts",qualifiedName:"Partial"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.TypeOptions"},name:"TypeOptions",package:"cypress",qualifiedName:"Cypress.TypeOptions"}],name:"Partial",package:"typescript"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:13,name:"typeIntoUi5TextArea",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:30,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L30"}],signatures:[{id:14,name:"typeIntoUi5TextArea",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Types a value into "},{kind:"code",text:"`ui5-textarea`"},{kind:"text",text:"."}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-textarea]').typeIntoUi5TextArea('Hello World');\n```"}]}]},sources:[{fileName:"commands.ts",line:30,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L30"}],parameters:[{id:15,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"Text that will be typed into the text-area."}]},type:{type:"intrinsic",name:"string"}},{id:16,name:"options",variant:"param",kind:32768,flags:{isOptional:!0},type:{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.es5.d.ts",qualifiedName:"Partial"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.TypeOptions"},name:"TypeOptions",package:"cypress",qualifiedName:"Cypress.TypeOptions"}],name:"Partial",package:"typescript"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]}],groups:[{title:"Methods",children:[25,21,23,17,19,4,8,13]}],sources:[{fileName:"commands.ts",line:4,character:14,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L4"}]}],groups:[{title:"Interfaces",children:[3]}],sources:[{fileName:"commands.ts",line:3,character:12,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L3"}]}],groups:[{title:"Namespaces",children:[2]}],sources:[{fileName:"commands.ts",line:1,character:0,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/commands.ts#L1"}]},{id:29,name:"src/queries",variant:"declaration",kind:2,flags:{},children:[{id:30,name:"Cypress",variant:"declaration",kind:4,flags:{},children:[{id:31,name:"Chainable",variant:"declaration",kind:256,flags:{},children:[{id:32,name:"findUi5TabByText",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"queries.ts",line:15,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/queries.ts#L15"}],signatures:[{id:33,name:"findUi5TabByText",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Returns the tab of the "},{kind:"code",text:"`ui5-tabcontainer`"},{kind:"text",text:` by its text.

__Note:__ Has to be chained to a `},{kind:"code",text:"`ui5-tabcontainer`"},{kind:"text",text:`.
__Note:__ This will not work for sub-tabs.`}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-tab-container]').findUi5TabByText('Tab 1');\n```"}]}]},sources:[{fileName:"queries.ts",line:15,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/queries.ts#L15"}],parameters:[{id:34,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"The text of the tab that should be queried."}]},type:{type:"intrinsic",name:"string"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:35,name:"findUi5TabOpenPopoverButtonByText",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"queries.ts",line:26,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/queries.ts#L26"}],signatures:[{id:36,name:"findUi5TabOpenPopoverButtonByText",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:`Returns the open-popover button for sub-tabs by its text.

__Note:__ Has to be chained to a `},{kind:"code",text:"`ui5-tabcontainer`"},{kind:"text",text:`.
__Note:__ The tab only renders a button fur sub-tabs if the tab itself has content, otherwise the whole tab is responsible for opening the popover.`}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-tab-container]').findUi5TabOpenPopoverButtonByText('Tab 1.1');\n```"}]}]},sources:[{fileName:"queries.ts",line:26,character:6,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/queries.ts#L26"}],parameters:[{id:37,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"The text of the sub-tab that should be queried."}]},type:{type:"intrinsic",name:"string"}},{id:38,name:"options",variant:"param",kind:32768,flags:{isOptional:!0},type:{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.es5.d.ts",qualifiedName:"Partial"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.ClickOptions"},name:"ClickOptions",package:"cypress",qualifiedName:"Cypress.ClickOptions"}],name:"Partial",package:"typescript"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]}],groups:[{title:"Methods",children:[32,35]}],sources:[{fileName:"queries.ts",line:4,character:14,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/queries.ts#L4"}]}],groups:[{title:"Interfaces",children:[31]}],sources:[{fileName:"queries.ts",line:3,character:12,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/queries.ts#L3"}]}],groups:[{title:"Namespaces",children:[30]}],sources:[{fileName:"queries.ts",line:1,character:0,url:"https://github.com/fioneer/ui5-webcomponents-react-fioneer/blob/1f2ee04/packages/cypress-commands/src/queries.ts#L1"}]}],A=[{title:"Modules",children:[28,1,29]}],j="ui5-webcomponents-react",P=[{kind:"text",text:`<a name="top"></a>
